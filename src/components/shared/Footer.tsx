        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">LedgerSwap</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              A secure and decentralized platform for cryptocurrency exchange. Trade with confidence on our peer-to-peer network.
            </p>
        ...
        <div className="border-t border-gray-800 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} LedgerSwap. All rights reserved.
            </p>
