    ...
    <section className="bg-[#001233] w-full flex items-center justify-center p-4 md:p-12">
      <div className="w-full sm:w-[95%] md:w-[90%] px-0">
        <div className="relative bg-gradient-to-r from-[#162456] to-[#162456] rounded-xl sm:rounded-2xl md:rounded-3xl shadow-md flex items-center justify-between min-h-[180px] sm:min-h-[200px]">
          ...
          <div className="hidden sm:block absolute -left-[20px] sm:-left-[40px] md:-left-[80px] lg:-left-[100px] bottom-0 w-[200px] sm:w-[300px] md:w-[400px] h-[150px] sm:h-[180px] md:h-[200px] pointer-events-none z-20">
            <img
          ...
          <div className="hidden sm:block absolute -right-[20px] sm:-right-[40px] md:-right-[80px] lg:-right-[100px] bottom-0 w-[200px] sm:w-[300px] md:w-[400px] h-[150px] sm:h-[180px] md:h-[200px] pointer-events-none z-20">
            <img
