  ...
  return (
    <div className=" text-black relative">
      <div className="flex justify-between text-black items-center mb-6">
        <h1 className="text-2xl font-medium">Platform Fee Configuration</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 mb-6">
        <h2 className="text-lg font-medium mb-4">Platform Swap Fee (%)</h2>
        ...
        <div className="  rounded-lg mt-5 p-6  bg-gray-50">
        <h2 className="text-lg font-medium mb-4">Fee Revenue (Last 30 Days)</h2>
        <div className="mb-2">
          <span className="text-3xl font-semibold text-blue-600">$142,850</span>
        </div>
        <p className="text-gray-500">From 28,570 transactions</p>
      </div>
