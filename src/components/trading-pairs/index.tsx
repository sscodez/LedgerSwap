...
const PairRow = ({ id, fromCoin, toCoin, price }: PairRowProps) => (
  <motion.div 
    className="flex items-center justify-between p-2 sm:p-3 md:p-4 bg-[#0A1E56] hover:bg-[#ffffff] hover:text-black text-white transition-colors rounded-xl mb-2 sm:mb-3 group"
